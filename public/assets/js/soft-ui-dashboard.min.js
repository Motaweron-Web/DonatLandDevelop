...
function darkMode(e) {
    const t = document.getElementsByTagName("body")[0], a = document.querySelectorAll("div:not(.sidenav) > hr"),
        ...
        p = document.querySelectorAll(".navbar g"), w = document.querySelector(".navbar-brand-img"), x = w.src,
    ...
    if (e.getAttribute("checked")) {
        t.classList.remove("dark-version"), n.classList.add("bg-white"), x.includes("logo-ct.png") && (B = x.replace("logo-ct", "logo-ct-dark"), w.src = B);
        ...
        for (C = 0; C < A.length; C++) A[C].classList.add("blur", "shadow-blur");
        ...
        for (C = 0; C < p.length; C++) p[C].hasAttribute("fill") && p[C].setAttribute("fill", "#fff");
        ...
        var B;
        t.classList.add("dark-version"), x.includes("logo-ct-dark.png") && (B = x.replace("logo-ct-dark", "logo-ct"), w.src = B);
        for (var C = 0; C < A.length; C++) A[C].classList.contains("blur") && A[C].classList.remove("blur", "shadow-blur");
        for (var C = 0; C < L.length; C++) L[C].classList.contains("text-white") && L[C].classList.remove("text-white");
        ...
        for (C = 0; C < b.length; C++) b[C].classList.add("border-dark");
