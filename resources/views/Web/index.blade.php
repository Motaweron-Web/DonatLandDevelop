                ...
                <div class="card bg-gradient-primary">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8 ">
                                <div class="numbers">
                                    <p class="text-white text-sm mb-0 opacity-7">الطلبات الجديدة</p>
...
{{--                                    <i class="fas fa-shopping-basket"></i>--}}
                                    <i class="fas fa-shopping-basket text-dark text-lg opacity-10" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card bg-gradient-danger">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8 ">
                                <div class="numbers">
                                    <p class="text-white text-sm mb-0 opacity-7">الطلبات الحالية</p>
                                    <h5 class="text-white font-weight-bolder mb-0">
                                        {{$accept_order_count}}
                                    </h5>
                                </div>
                            ...
                            <div class="col-4 text-start">
                                <div class="icon icon-shape bg-white shadow text-center border-radius-md">
                                    <i class="fas fa-shopping-cart text-dark text-lg opacity-10" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 p-2 ">
                <div class="card bg-gradient-faded-info">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8 ">
                                <div class="numbers">
                                    <p class="text-white text-sm mb-0 opacity-7">الشكاوى </p>
                                    <h5 class="text-white font-weight-bolder mb-0">
                                        {{$contact_count}}
                                    </h5>
                                </div>
                            ...
                            <div class="col-4 text-start">
                                <div class="icon icon-shape bg-white shadow text-center border-radius-md">
                                    <i class="fas fa-comment text-dark text-lg opacity-10" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 p-2 ">
                <div class="card bg-gradient-faded-primary">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8 ">
                                <div class="numbers">
                                    <p class="text-white text-sm mb-0 opacity-7">المشرفين</p>
                                    <h5 class="text-white font-weight-bolder mb-0">
                                        {{$user_count}}
                                    </h5>
                                </div>
                ...
                <div class="card bg-gradient-secondary">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8 ">
                                <div class="numbers">
                                    <p class="text-white text-sm mb-0 opacity-7">العملاء</p>
                                    <h5 class="text-white font-weight-bolder mb-0">
                                        {{$customer_count}}
                                    </h5>
                                </div>
                            ...
                            <div class="col-4 text-start">
                                <div class="icon icon-shape bg-white shadow text-center border-radius-md">
                                    <i class="fas fa-user-alt text-dark text-lg opacity-10" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card bg-gradient-dark">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8 ">
                                <div class="numbers">
                                    <p class="text-white text-sm mb-0 opacity-7">المندوبين</p>
                                    <h5 class="text-white font-weight-bolder mb-0">
                            ...
                            <div class="col-4 text-start">
                                <div class="icon icon-shape bg-white shadow text-center border-radius-md">
                                    <i class="fas fa-truck text-dark text-lg opacity-10" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>
                    </div>
