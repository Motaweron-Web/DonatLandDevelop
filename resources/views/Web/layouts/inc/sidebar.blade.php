...
{{--                        </svg>--}}
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#contactExamples" class="nav-link active_main_tap {{Route::is('contact.*')? 'active' :'collapsed'}}" aria-controls="componentsExamples" role="button" aria-expanded="{{Route::is('contact.*')? 'true' :'false'}}">
                    ...
                    <span class="nav-link-text me-1">قائمة الفروع</span>
                </a>
                <div class="collapse {{Route::is('branch.*') ? 'show' :''}}" id="contactExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link {{Route::is('branch.all') ? 'active' :''}}"  href="{{aurl('branch/all')}}" >
                                <span class="sidenav-mini-icon"> م </span>
                                <span class="sidenav-normal">  قائمة الفروع </span>
                            </a>
                        </li>
